...
{
    $q =  mysqli_query($db, "SELECT * FROM `Carte` WHERE Titlu LIKE '%$_POST[search]%' ");
    if (mysqli_num_rows($q) == 0)
    {
        echo "Nu exista nicio carte cu acest nume";
    }
    else {
...
//Table header
        ...
        echo "<th>"; echo "An de publicare";  echo "</th>";
        echo "<th>"; echo "Categorie";  echo "</th>";
        echo "<th>"; echo "Editura";  echo "</th>";
        echo "<th>"; echo "Pagini";  echo "</th>";
        echo "<th>"; echo "Descriere scurta";  echo "</th>";
        echo "<th>"; echo "Descriere lunga";  echo "</th>";
        ...
        while($row=mysqli_fetch_assoc($q))
        {
            ...
            echo "<td>"; echo $row['An de publicare']; echo "</td>";
            echo "<td>"; echo $row['Categorie']; echo "</td>";
            echo "<td>"; echo $row['Editura']; echo "</td>";
            echo "<td>"; echo $row['Pagini']; echo "</td>";
            echo "<td>"; echo $row['Descriere scurta']; echo "</td>";
            echo "<td>"; echo $row['Descriere lunga']; echo "</td>";
    ...
    $res=mysqli_query($db,"SELECT * FROM `Carte` ORDER BY `Carte`.`ID` ASC;");
    echo "<table class='table table-bordered table-hover' >";
    echo "<tr style='background-color: white;'>";
//Table header
    echo "<th>"; echo "ID";	echo "</th>";
